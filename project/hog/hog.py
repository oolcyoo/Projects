...
def picky_piggy(score):
    ...
    if count == 0:
        ...
        point = (pp_value//(1000000/(10**count)))%10
    elif count%6 == 0:
        point = 7
    else:
        point = (pp_value//(1000000/(10**(count%6))))%10
...
def take_turn(num_rolls, opponent_score, dice=six_sided, goal=GOAL_SCORE):
    ...
    while goal <= 100:
        ...
        if num_rolls == 0:
            turn_point = picky_piggy(opponent_score)
        else:
            turn_point = roll_dice(num_rolls, dice)
        return turn_point
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            score0 = take_turn(strategy0(score0, opponent_score), opponent_score, dice, goal) + score0
            who = next_player(who)
            
            if score0 == score1:
                score0 = hog_pile(score0, opponent_score) + score0
            ...
            score1 = take_turn(strategy1(score1, opponent_score), opponent_score, dice, goal) + score1
            who = next_player(who)
            
            if score0 == score1:
                score1 = hog_pile(score1, opponent_score) + score1
            say = say(score0, score1)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def helper(score0,score1):
        ...
        if current_score - last_score > running_high:
            highest = current_score - last_score
            print(str(highest) + " point(s)! That's a record gain for Player " + str(who) + "!")
        else:
...
def make_averaged(original_function, trials_count=1000):
    ...
    #the for loop iterates how many trails are counted (1000)
    #while the for loop is going a totak is summed
    #it then returns an average that make_averaged will return
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    result = 1 
    score = make_averaged(roll_dice, trials_count)(result, dice)
    for i in range(2, 11):
...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    if hog_pile(score, opponent_score) == score or picky_piggy_strategy(score, opponent_score, cutoff, num_rolls) == 0:
        return 0
    return num_rolls
